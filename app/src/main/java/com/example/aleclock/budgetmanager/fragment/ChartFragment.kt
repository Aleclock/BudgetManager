package com.example.aleclock.budgetmanager.fragment
...
import com.example.aleclock.budgetmanager.RoundedBarChartRenderer
...
class GraphFragment : Fragment() {
    ...
    private var tabLayoutType: TabLayout? = null
        ...
        if (userId == null) {
            ...
            ref.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    setupPositiveNegativeData(barChart, listToData(expenseList, incomeList), listToXAxisData(expenseList))
                    s.hide()
                }
    ...
    private fun listToData(expenseList: FloatArray, incomeList: FloatArray): ArrayList<Data> {
        ...
        val dataXAxis = ArrayList<Int>()

        for (x in expenseList.indices) {
            data.add(Data(x.toFloat(),expenseList[x], (x+1).toString()))
            data.add(Data(x.toFloat(),incomeList[x], (x+1).toString()))
            dataXAxis.add(x+1)
        }
/*
        for (x in expenseList.indices) {
    ...
    private fun listToXAxisData(expenseList: FloatArray): ArrayList<Int> {
        val dataXAxis = ArrayList<Int>()
    ...
    // Impostazione della legenda
        ...
        pieChart.setExtraOffsets(60f, 0f, 60f, 5f)
     ...
     */
    private fun setupPositiveNegativeData(barChart: BarChart, data: ArrayList<Data> , dataXAxis: ArrayList<Int>) {
...
/*        xAxis.valueFormatter = object : ValueFormatter() {
    ...
    private fun initTitleBarButtons(pieChart: PieChart, barChart: BarChart) {
        ...
        btnFilter.setOnClickListener {
            ...
            val items = arrayOf(getString(R.string.monthly), getString(
                R.string.yearly
            ))
    ...
    fun setDateBar(date: String?, period: String) {
