...
import com.example.aleclock.budgetmanager.*
...
import com.example.aleclock.budgetmanager.activity.TransactionDetailActivity
import com.example.aleclock.budgetmanager.transaction.TransactionCategoryItem
import com.example.aleclock.budgetmanager.transaction.TransactionItem
            ...
            if ((transactionCategoryEx.size == 0 && transactionCategoryIn.size == 0) || (accountListId.size == 0)) {
                ...
                val type_adapter =
                    ArrayAdapter(context,
                        R.layout.select_dialog_item_material, accountListName)
                ...
                newTransactionAmount.addTextChangedListener(
                    MoneyTextWatcher(
    ...
    private fun showNewTransactionDialog(item: TransactionModelItem) {
        ...
        if ((transactionCategoryEx.size == 0 && transactionCategoryIn.size == 0) || (accountListId.size == 0)) {
            ...
            if (item.transactionType == "expense") {
                ...
                transactionCategories = transactionCategoryEx
                transactionType = "expense"
                categoryAdapter = ArrayAdapter(context!!,
                    R.layout.select_dialog_item_material, transactionCategories)
            ...
            val accountAdapter = ArrayAdapter(context,
                R.layout.select_dialog_item_material, accountListName)
