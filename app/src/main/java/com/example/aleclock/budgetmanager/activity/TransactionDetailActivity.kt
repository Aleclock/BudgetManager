...
import com.example.aleclock.budgetmanager.transaction.TransactionDetailItem
...
class TransactionDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val amount = df.format(transaction.amount)

        txtAmount.text = concat( amount, "  €")
        ...
        if (userId == null) return
            ...
            reference.setValue(model)
                .addOnSuccessListener {
                    Sneaker.with(this)
                        .setTitle(getString(R.string.model_created))
                        .setDuration(2000)
                        .sneak(R.color.colorPrimary)
                }
                .addOnFailureListener {
                    Sneaker.with(this)
                        .setTitle(getString(R.string.model_not_created))
                        .setDuration(2000)
