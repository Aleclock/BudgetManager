...
import com.example.aleclock.budgetmanager.activity.IncomeCategoryActivity
...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val emailTxt = view.findViewById<TextView>(R.id.txt_email)
        setEmail(emailTxt)
            ...
            when(id.toInt()) {
                0 -> {
                    val intent = Intent(context,
                        ExpenseCategoryActivity::class.java)
                    startActivity(intent)
                }
                1 -> {
                    val intent = Intent(context,
                        IncomeCategoryActivity::class.java)
                    startActivity(intent)
                }
                2 -> {
                    val intent = Intent(context,
    ...
    private fun setEmail(emailTxt: TextView) {
        val email = LoginActivity.getEmail()
        emailTxt.text = email
    }
