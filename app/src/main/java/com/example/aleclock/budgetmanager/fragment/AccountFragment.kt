...
import com.example.aleclock.budgetmanager.account.AccountItem
import com.example.aleclock.budgetmanager.account.AccountRowItem
import com.example.aleclock.budgetmanager.MoneyTextWatcher
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_show_dialog.setOnClickListener {
            ...
            val adapter = ArrayAdapter(context,
                R.layout.select_dialog_item_material,categories)
            ...
            newAccountBalance.addTextChangedListener(
                MoneyTextWatcher(
                    newAccountBalance
                )
            )
            ...
            btn.setOnClickListener {
                ...
                val balanceText = newAccountBalance.text

                if (newAccountName.toString() == "" || balanceText.toString() == "") {
                    Sneaker.with(this)
                    ...
                    val balance =
                        balanceText.substring(2, newAccountBalance.text.length).replace(",", "")
